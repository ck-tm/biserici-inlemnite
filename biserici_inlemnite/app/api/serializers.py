    ...
    def get_sections(self, obj):
        sections = [
            ...
            },
            {
                "title": "Persoane",
                "subsections": [
                    {"title": "Ctitori", "fields": [("ctitori", "Nume")]},
                    {"title": "Meșteri", "fields": [("mesteri", "Nume")]},
                    {"title": "Zugravi", "fields": [("zugravi", "Nume")]},
                    {
                        "title": "Personalități",
                        "fields": [("personalitati", "Nume")],
                    },
                ],
            },
            {
