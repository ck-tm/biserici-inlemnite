...
@method_decorator(
    cached_view_as(
        models.BisericaPage,
        models.IdentificarePage,
        models.DescrierePage,
        models.ComponentaArtisticaPage,
        models.ConservarePage,
        models.ValoarePage,
        models.IstoricPage,
    ),
    name="dispatch",
...
class MapViewSet(ModelViewSet):
    ...
    def list(self, request):
        ...
        if query:
            q = (
                Q(utitle__icontains=query)
                | Q(cod__icontains=query)
                | Q(identificare_page__localitate__nume__icontains=query)
            )
...
class FiltersView(ViewSet):
    ...
    def list(self, request):
        ...
        identificare_filters = utils.get_chapter_filters(models.IdentificarePage, identificare_filters_name)
        ...
        istoric_filters = utils.get_chapter_filters(models.IstoricPage, istoric_filters_name)
        # print('----')
        # pprint(istoric_filters)
        # print('----')
        descriere_filters_name = {
            "Tip scanare": ["are_scanare_laser", "are_model_fotogrametric"],
            "Localizare/Peisaj": [
                "amplasament",
                "topografie",
        ...
        descriere_filters = utils.get_chapter_filters(models.DescrierePage, descriere_filters_name)
        ...
        componenta_artistica_name = {
            ...
            "Altar": ["altar_placa_mesei", "altar_piciorul_mesei"],
            "Pictură exterioară": [
            ...
            "Intervenții": ["elemente_interventii"],
        }
        ...
        advanced_conservare_filters = utils.get_chapter_filters(models.ConservarePage, conservare_filters_name)
        ...
        advanced_valoare_filters = utils.get_chapter_filters(models.ValoarePage, valoare_filters_name)
        ...
        localitati_active = models.BisericaPage.objects.live().values(
            "identificare_page__localitate__id",
            "identificare_page__localitate__nume",
            "identificare_page__localitate__judet__id",
            "identificare_page__localitate__judet__nume",
        )
    ...
    def filters_preview(self, request):
        response = {"count": utils.filter_biserici(request.data).count()}
        return Response(response)
