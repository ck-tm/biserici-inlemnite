...
class ReadOnlyPanel(EditHandler):
    ...
    def render_as_field(self):
        return format_html(
            '<div class="field">' "<label>{}{}</label>" '<div class="field-content">{}</div>' "</div>",
            self.heading,
            ":",
            self.render(),
        )
...
class ParteneriProiect(Orderable):
    page = ParentalKey("AboutPage", on_delete=models.CASCADE, related_name="parteneri")
...
class PozeBiserica(Orderable):
    page = ParentalKey("BisericaPage", on_delete=models.CASCADE, related_name="poze")
    poza = models.ForeignKey(
        "wagtailimages.Image",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
...
class BisericaPage(ModelMeta, Page):
    ...
    identificare_page = models.ForeignKey("IdentificarePage", null=True, blank=True, on_delete=models.SET_NULL)
    descriere_page = models.ForeignKey("DescrierePage", null=True, blank=True, on_delete=models.SET_NULL)
    componenta_artistica_page = models.ForeignKey(
        "ComponentaArtisticaPage",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
    )
    istoric_page = models.ForeignKey("IstoricPage", null=True, blank=True, on_delete=models.SET_NULL)
    valoare_page = models.ForeignKey("ValoarePage", null=True, blank=True, on_delete=models.SET_NULL)
    conservare_page = models.ForeignKey("ConservarePage", null=True, blank=True, on_delete=models.SET_NULL)
...
class IdentificarePage(Page):
    ...
    cult = models.ForeignKey(
        "nomenclatoare.CultBiserica",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        related_name="p_biserici",
    )
    utilizare = models.ForeignKey(
        "nomenclatoare.UtilizareBiserica",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        related_name="p_biserici",
    ...
    singularitate = models.ForeignKey(
        "nomenclatoare.SingularitateBiserica",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        related_name="p_biserici",
    ...
    functiune = models.ForeignKey(
        "nomenclatoare.FunctiuneBiserica",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        related_name="p_biserici",
    ...
    functiune_initiala = models.ForeignKey(
        "nomenclatoare.FunctiuneBiserica",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
    ...
    proprietate_actuala = models.ForeignKey(
        "nomenclatoare.RegimProprietate",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        related_name="p_biserici_initiale",
...
class PozeElementImportantAnsambluConstruit(Orderable):
    page = ParentalKey(
        "ElementeImportanteAnsambluConstruit",
        on_delete=models.CASCADE,
        related_name="poze",
    )
    poza = models.ForeignKey(
...
class FinisajePortic(ClusterableModel, Orderable):
    ...
    element = models.ForeignKey(
        "nomenclatoare.ElementInteriorBiserica",
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
    )
...
class Poza(models.Model):
    ...
    panels = [ImageChooserPanel("poza"), FieldPanel("observatii")]
...
class PozeDescriereBolti(Orderable, Poza):
    page = ParentalKey("DescrierePage", on_delete=models.CASCADE, related_name="poze_bolti")
...
class PozeFundatie(Orderable, Poza):
    page = ParentalKey("DescrierePage", on_delete=models.CASCADE, related_name="poze_fundatie")
...
class PozeTiranti(Orderable, Poza):
    page = ParentalKey("DescrierePage", on_delete=models.CASCADE, related_name="poze_tiranti")
...
class PozeEtapeIstoriceVizibile(Orderable):
    page = ParentalKey("EtapeIstoriceVizibile", on_delete=models.CASCADE, related_name="poze")
    poza = models.ForeignKey(
        "wagtailimages.Image",
        null=True,
        blank=True,
...
class DescrierePage(Page):
    ...
    amplasament = models.ForeignKey(
        "nomenclatoare.AmplasamentBiserica",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
    )
    topografie = models.ForeignKey(
        "nomenclatoare.TopografieBiserica",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
    )
    ...
    materiale = models.ForeignKey(
        "nomenclatoare.MaterialeStructura",
        help_text="Materiale folosite in construcția bisericii",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
    )
    detalii_materiale = RichTextField(
        features=[],
        null=True,
        blank=True,
    ...
    turn_dimensiune = models.ForeignKey(
        "nomenclatoare.DimensiuneTurn",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        verbose_name="Dimensiune",
    )
    turn_tip = models.ForeignKey(
        "nomenclatoare.TipTurn",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        verbose_name="Tip",
    ...
    turn_plan = models.ForeignKey(
        "nomenclatoare.PlanTurn",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        verbose_name="Plan",
    ...
    turn_amplasare = models.ForeignKey(
        "nomenclatoare.AmplasareTurn",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        verbose_name="Amplasare",
    )
    turn_galerie = models.ForeignKey(
        "nomenclatoare.GalerieTurn",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
    ...
    turn_numar_arcade_observatii = RichTextField(
        ...
        null=True,
        blank=True,
        verbose_name="Detalii arcade Turn deschis",
    )
    turn_asezare_talpi = models.ForeignKey(
        "nomenclatoare.AsezareTalpaTurn",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        verbose_name="Așezarea tălpilor turnului în legătură cu corpul bisericii",
    )
    turn_relatie_talpi = models.ForeignKey(
        "nomenclatoare.RelatieTalpaTurn",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        verbose_name="Relația dintre tălpile turnului",
    )
    ...
    sarpanta_tip = ParentalManyToManyField("nomenclatoare.TipSarpanta", blank=True, verbose_name="Tip")
    ...
    sarpanta_material_cruci = models.ForeignKey(
        "nomenclatoare.MaterialCruci",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
    ...
    bolta_peste_pronaos = models.ForeignKey(
        "nomenclatoare.TipBoltaPronaos",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
    ...
    bolta_peste_pronaos_structura = ParentalManyToManyField(
        "nomenclatoare.MaterialeStructuraBolta",
        blank=True,
        verbose_name="Structură boltă/tavan pronaos",
        related_name="p_pronaos",
    )

    bolta_peste_naos = models.ForeignKey(
        "nomenclatoare.TipBoltaPronaos",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
    ...
    bolta_peste_altar = models.ForeignKey(
        "nomenclatoare.BoltaPesteAltar",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
    ...
    bolta_peste_altar_tip = models.ForeignKey(
        "nomenclatoare.TipBoltaPesteAltar",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        verbose_name="Tip",
    ...
    cor_material = ParentalManyToManyField("nomenclatoare.MaterialCor", blank=True, related_name="p_biserici_cor")
    ...
    # Structura
    fundatia = models.ForeignKey(
        "nomenclatoare.TipFundatie",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
    ...
    sistem_structural = models.ForeignKey(
        "nomenclatoare.TipSistemStructural",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        verbose_name="Tip",
    ...
    sistem_structural_observatii = RichTextField(features=[], null=True, blank=True, verbose_name="Observații")
    sistem_in_cheotoare = models.ForeignKey(
        "nomenclatoare.TipStructuraCheotoare",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        verbose_name="Tip",
    ...
    sistem_in_catei = models.ForeignKey(
        "nomenclatoare.TipStructuraCatei",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        verbose_name="Tip",
    ...
    tiranti_tip = models.ForeignKey(
        "nomenclatoare.TipTiranti",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
    ...
    finisaj_exterior_tip = ParentalManyToManyField(
        "nomenclatoare.FinisajExterior",
        blank=True,
        verbose_name="Finisaj exterior corp",
    )
    ...
    invelitoare_corp_material = models.ForeignKey(
        "nomenclatoare.FinisajInvelitoare",
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        verbose_name="Material",
    ...
    invelitoare_corp_sindrila_lungime = models.FloatField(null=True, blank=True, verbose_name="Șindrila (lungime)")
    ...
    invelitoare_corp_sindrlia_tipul_de_batere = models.ForeignKey(
        "nomenclatoare.TipBatereSindrila",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        verbose_name="Șindrila (tipul de batere)",
        related_name="invelitoare_corp",
    )
    invelitoare_corp_sindrlia_tipul_prindere = models.ForeignKey(
        "nomenclatoare.TipPrindereSindrila",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        verbose_name="Șindrila (tipul de prindere)",
        related_name="invelitoare_corp",
    )
    invelitoare_corp_sindrlia_forma_botului = models.ForeignKey(
        "nomenclatoare.TipBotSindrila",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        verbose_name="Șindrila (forma botului)",
        related_name="invelitoare_corp",
    )
    ...
    invelitoare_corp_sindrlia_prelucrare = models.ForeignKey(
        "nomenclatoare.TipPrelucrareSindrila",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        verbose_name="Șindrila (prelucrare)",
        related_name="invelitoare_corp",
    )
    invelitoare_corp_sindrlia_esenta_lemnoasa = models.ForeignKey(
        "nomenclatoare.EsentaLemnoasa",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        verbose_name="Șindrila (esență lemnoasă)",
        related_name="invelitoare_corp_sindrlia_esenta",
    )
    ...
    invelitoare_turn_sindrila_lungime = models.FloatField(null=True, blank=True, verbose_name="Șindrila (lungime)")
    ...
    invelitoare_turn_sindrlia_esenta_lemnoasa = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        verbose_name="Șindrila (esență lemnoasă)",
        related_name="invelitoare_turn_sindrlia_esenta",
    )
    ...
    inchidere_tambur_turn_sindrila_lungime = models.FloatField(null=True, blank=True, verbose_name="Șindrila (lungime)")
    ...
    inchidere_tambur_turn_sindrlia_tipul_de_batere = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        verbose_name="Șindrila (tipul de batere)",
        related_name="inchidere_tambur_turn",
    )
    ...
    inchidere_tambur_turn_sindrlia_esenta_lemnoasa = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        verbose_name="Șindrila (esență lemnoasă)",
        related_name="inchidere_tambur_turn_sindrlia_esenta",
    )
    ...
    invelitoare_turle_sindrila_lungime = models.FloatField(null=True, blank=True, verbose_name="Șindrila (lungime)")
    ...
    invelitoare_turle_sindrlia_tipul_de_batere = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        verbose_name="Șindrila (tipul de batere)",
        related_name="invelitoare_turle",
    )
    ...
    invelitoare_turle_sindrlia_esenta_lemnoasa = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        verbose_name="Șindrila (esență lemnoasă)",
        related_name="invelitoare_turle_sindrlia_esenta",
    )
    ...
    interventii_invelitoare_etape_anterioare_vizibile = models.BooleanField(default=False, verbose_name="Vizibile")
    ...
    interventii_invelitoare_sindrila_cu_horj = models.BooleanField(default=False, verbose_name="Cu horj")
    ...
    interventii_invelitoare_sindrila_cu_tesitura = models.BooleanField(default=False, verbose_name="Cu teșitură")
    ...
    ansamblu_panels = [
        InlinePanel(
            "elemente_ansamblu_construit",
            label="element arhitectural",
            classname="collapsible collapsed ",
        ),
        InlinePanel(
            "elemente_importante_ansamblu_construit",
    ...
    arhitectura_panels = [
        ...
        MultiFieldPanel(
            [
                ...
                MultiFieldPanel([InlinePanel("poze_accese", label="Poza")]),
            ],
        ...
        MultiFieldPanel(
            [
                ...
                MultiFieldPanel([InlinePanel("poze_ferestre", label="Poza")]),
            ],
        ...
        MultiFieldPanel(
            [
                ...
                MultiFieldPanel([InlinePanel("poze_ochiesi", label="Poza")]),
            ],
        ...
        MultiFieldPanel(
            [
                ...
                MultiFieldPanel([InlinePanel("poze_solee", label="Poza")]),
            ],
            heading="Solee",
            classname="collapsible collapsed ",
        ),
        MultiFieldPanel(
            [
                ...
                MultiFieldPanel([InlinePanel("poze_masa_atlar", label="Poza")]),
            ],
            heading="Masă altar",
            classname="collapsible collapsed ",
        ),
        ...
        MultiFieldPanel(
            [
                ...
                MultiFieldPanel([InlinePanel("poze_cor", label="Poza")]),
            ],
            heading="Cor",
            classname="collapsible collapsed ",
        ),
        MultiFieldPanel(
            [
                ...
                MultiFieldPanel([InlinePanel("poze_sarpanta", label="Poza")]),
            ],
        ...
        MultiFieldPanel(
            [
                ...
                MultiFieldPanel([InlinePanel("poze_turn", label="Poza")]),
            ],
            heading="Turn",
            classname="collapsible collapsed ",
        ),
        MultiFieldPanel(
            [
                ...
                MultiFieldPanel([InlinePanel("poze_clopote", label="Poza")]),
            ],
            heading="Clopote",
            classname="collapsible collapsed ",
        ),
        MultiFieldPanel(
            [
                ...
                MultiFieldPanel([InlinePanel("poze_turle", label="Poza")]),
            ],
            heading="Turle",
            classname="collapsible collapsed ",
        ),
...
class PozeCtitori(Orderable):
    page = ParentalKey("Ctitori", on_delete=models.CASCADE, related_name="poze")
    poza = models.ForeignKey(
        "wagtailimages.Image",
        null=True,
        blank=True,
...
class Ctitori(ClusterableModel, Orderable, Persoana):
    ...
    panels = Persoana.panels + [InlinePanel("poze", label="Poză")]


class PozeMesteri(Orderable):
    page = ParentalKey("Mesteri", on_delete=models.CASCADE, related_name="poze")
    poza = models.ForeignKey(
        "wagtailimages.Image",
        null=True,
        blank=True,
...
class PozeZugravi(Orderable):
    page = ParentalKey("Zugravi", on_delete=models.CASCADE, related_name="poze")
    poza = models.ForeignKey(
        "wagtailimages.Image",
        null=True,
        blank=True,
...
class PozePersonalitati(Orderable):
    page = ParentalKey("Personalitati", on_delete=models.CASCADE, related_name="poze")
    poza = models.ForeignKey(
        "wagtailimages.Image",
        null=True,
        blank=True,
...
class PozePisanie(Orderable, Poza):
    page = ParentalKey("IstoricPage", on_delete=models.CASCADE, related_name="poze_pisanie")


class IstoricPage(Page):
    sursa_datare = ParentalManyToManyField("nomenclatoare.SursaDatare", related_name="p_biserici", blank=True)
    ...
    datare_secol = models.ForeignKey(
        "nomenclatoare.Secol",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
    ...
    ctitori_panels = [InlinePanel("ctitori", label="ctitori")]

    mesteri_panels = [InlinePanel("mesteri", label="mesteri")]

    zugravi_panels = [InlinePanel("zugravi", label="zugravi")]

    personalitati_panels = [InlinePanel("personalitati", label="personalitati")]

    evenimente_panels = [InlinePanel("evenimente", label="evenimente")]

    mutari_panels = [InlinePanel("mutari", label="mutari")]

    povesti_panels = [InlinePanel("povesti", label="povesti")]
...
class ValoarePage(Page):
    ...
    vechime = models.IntegerField(
        choices=CLASE_EVALUARE,
        null=True,
        blank=True,
    ...
    integritate = models.IntegerField(
        choices=CLASE_EVALUARE,
        null=True,
        blank=True,
    ...
    peisaj_cultural = models.IntegerField(
        choices=CLASE_EVALUARE,
        null=True,
        blank=True,
    ...
    valoare_sit = models.IntegerField(
        choices=CLASE_EVALUARE,
        null=True,
        blank=True,
    ...
    valoare_sit_observatii = RichTextField(features=[], null=True, blank=True, verbose_name="Observații")

    estetica = models.IntegerField(
        choices=CLASE_EVALUARE,
        null=True,
        blank=True,
    ...
    folosinta_actuala = models.IntegerField(
        choices=CLASE_EVALUARE,
        null=True,
        blank=True,
    ...
    relevanta_actuala = models.IntegerField(
        choices=CLASE_EVALUARE,
        null=True,
        blank=True,
    ...
    class PozeSit(Orderable, Poza):
        page = ParentalKey("ConservarePage", on_delete=models.CASCADE, related_name="poze_sit")
    ...
    class PozeTurnConservare(Orderable, Poza):
        page = ParentalKey("ConservarePage", on_delete=models.CASCADE, related_name="poze_turn")
...
class ConservarePage(Page):
    ...
    sit_pericol = models.BooleanField(default=False, verbose_name="Pericol")
    ...
    elemente_arhitecturale_pericol = models.BooleanField(default=False, verbose_name="Pericol")
    ...
    alte_elemente_importante_pericol = models.BooleanField(default=False, verbose_name="Pericol")
...
class PozeIcoaneVechi(Orderable, Poza):
    page = ParentalKey(
        "ComponentaArtisticaPage",
        on_delete=models.CASCADE,
        related_name="poze_icoane_vechi",
    )
...
class ComponentaArtisticaPage(Page):
    ...
    suport_proscomidie = ParentalManyToManyField("nomenclatoare.SuportPictura", blank=True)
    ...
    obiecte_de_cult = ParentalManyToManyField("nomenclatoare.ObiectCult", verbose_name="Obiecte de cult", blank=True)
    obiecte_de_cult_observatii = RichTextField(features=[], null=True, blank=True, verbose_name="Observații")

    mobiliere = ParentalManyToManyField("nomenclatoare.MaterialMobilier", verbose_name="Mobilier", blank=True)
    ...
    iconostas_naos_altar_tip = models.ForeignKey(
        "nomenclatoare.TipIconostas",
        verbose_name="Tip",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
    ...
    iconostas_naos_altar_materiale = ParentalManyToManyField(
        "nomenclatoare.MaterialIconostas",
        verbose_name="Material",
        blank=True,
        related_name="p_iconostasuri_naos_altar",
    )
    ...
    iconostas_pronaos_naos_tip = models.ForeignKey(
        "nomenclatoare.TipIconostas",
        verbose_name="Tip",
        null=True,
        blank=True,
    ...
    altar_placa_mesei = ParentalManyToManyField(
        "nomenclatoare.MaterialMasaAltar",
    ...
    # Pictura Exterioara
    pictura_exterioara_localizare = models.ForeignKey(
        "nomenclatoare.LocalizarePictura",
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
    ...
    pictura_exterioara_tehnica = models.ForeignKey(
        "nomenclatoare.TehnicaPictura",
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name="p_localizari_exterioare",
    ...
    pictura_exterioara_datare_prin_interval_timp = models.CharField(
        ...
        null=True,
        blank=True,
        verbose_name="Datare prin interval de timp",
    )
    ...
    perete_despartitor_panels = [
        MultiFieldPanel(
            [
                ...
                FieldPanel(
                    "iconostas_pronaos_naos_tehnica",
                    widget=forms.CheckboxSelectMultiple,
                ),
    ...
    exterior_panels = [
        ...
        MultiFieldPanel(
            [
                FieldPanel(
                    "pictura_exterioara_sursa_datare",
                    widget=forms.CheckboxSelectMultiple,
                ),
    ...
    interior_panels = [
        ...
        MultiFieldPanel(
            [
                FieldPanel(
                    "pictura_interioara_sursa_datare",
                    widget=forms.CheckboxSelectMultiple,
                ),
