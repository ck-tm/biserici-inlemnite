...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('app', '0074_pozefinisajeexteriorcorp_pozefinisajeinchideretambur_pozefinisajeinvelitoare_pozefinisajeinvelitoare'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='poze_invelitoare_turle', to='app.descrierepage')),
